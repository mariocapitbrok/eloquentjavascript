...
// The (\d+) group ends up as the amount argument to the function, and the (\w+) group gets bound to unit. The uderscore '_' argument refers to the match returned but that is not been used inside the function.
